...
RSpec.describe "master_companies/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit master_company form" do
    render

    assert_select "form[action=?][method=?]", master_company_path(@master_company), "post" do
