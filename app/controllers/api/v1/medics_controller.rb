class Api::V1::MedicsController < ApplicationController
  ...
  def medic_params
    params.permit(:medic_code ,:medic_id ,:id_type ,:first_name1 ,:first_name2 ,:last_name1 ,:last_name2 ,:medical_record ,:phone ,:cellphone ,:email ,:agend_management ,:specialty_code)
  end
end
